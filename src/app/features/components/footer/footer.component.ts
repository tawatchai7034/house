...
export class FooterComponent {
  sections = [
    ...
    },
    {
      ...
      items: ["Northern Lights", "Whale Watching", "Ice Climbing", "Hot Air Ballooning"]
    },
    {
      title: "Travel Blogs",
      items: ["Bali Travel Guide", "How to Travel Alone", "How to Travel on a Budget", "How to Travel with Kids"]
    },
    {
      title: "About Us",
